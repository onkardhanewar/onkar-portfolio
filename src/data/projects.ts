...
export const projects: Project[] = [
  {
    ...
    description: 'An AI college assistance chatbot built with Python, Flask, NLTK, React, and Tailwind CSS to provide students with automated assistance for college admissions, placements, courses, and campus services.',
    technologies: ['Python', 'Flask', 'NLTK', 'React', 'Tailwind CSS', 'JSON', 'CSV', 'REST APIs'],
    features: [
      'NLP-based keyword processing & tokenization with NLTK',
      'Instant college admission assistance & eligibility guidance',
      'Placement records & recruiter information lookup',
      'Faculty profiles & department directories',
      'Campus facilities & hostel query resolution',
      'REST API backend using Python Flask for fast JSON responses',
...
def process_query(user_text, knowledge_base):
  ...
  },
  {
    ...
    description: 'An embedded surveillance robot built with ESP32-CAM, ESP8266 Wi-Fi module, L298N motor driver, and sensors for remote video monitoring, robotics telemetry, and perimeter reconnaissance.',
    technologies: ['ESP32-CAM', 'ESP8266', 'L298N', 'BO Motors', 'SG90 Servo', '18650 Battery', 'Land Mine Sensor', 'C++'],
    features: [
...
void executeCommand(char cmd) {
  ...
  },
  {
    ...
    filters: ['ALL', 'WEB'],
    description: 'A product website and responsive web application built using React, Vite, and Tailwind CSS for an RO water purifier business to display products, specifications, and service booking workflows.',
    technologies: ['React', 'Vite', 'JavaScript', 'Tailwind CSS', 'Framer Motion', 'Responsive Web Design'],
    features: [
      'Interactive product catalog with spec comparisons',
      'Fully responsive, mobile-first design system with Tailwind CSS',
      'Service booking & filter replacement inquiry form',
      'Customer reviews & warranty registration lookup',
      'High-performance asset optimization and fast bundling with Vite'
    ],
  ...
  },
  {
    ...
    description: 'A web-based student profile management application built with HTML, CSS, JavaScript, PHP, and MySQL for managing student records, profiles, and departmental academic data.',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'MySQL', 'SQL Database', 'CRUD'],
    features: [
      'Secure student registration & authentication system',
      'Comprehensive student profile CRUD operations with MySQL',
  ...
  },
  {
    ...
    badge: 'C++ LOGIC',
    filters: ['ALL', 'C++'],
    description: 'A scientific calculator program developed in C++ supporting complex scientific calculations, mathematical operations, trigonometry, logarithms, statistics, and bitwise logic.',
    technologies: ['C++', 'Algorithms', 'Mathematical Operations', 'STL', 'Data Structures'],
    features: [
  ...
  },
  {
    ...
    description: 'A database-driven record management system built with PHP, MySQL, HTML5, CSS3, and JavaScript for certificate verification, record management, and secure student credential lookup.',
    technologies: ['PHP', 'MySQL', 'HTML5', 'CSS3', 'JavaScript', 'SQL Database', 'REST APIs'],
    features: [
      'Certificate record generation & unique identifier hashing',
      'Student credential verification portal with MySQL query indexing',
